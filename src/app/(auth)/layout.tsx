export default function AuthLayout({
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center p-4 bg-surface-primary">
      ...
      <div className="fixed inset-0 bg-[linear-gradient(rgba(0,229,220,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,229,220,0.03)_1px,transparent_1px)] bg-[size:64px_64px]" />
      {/* Radial glow */}
