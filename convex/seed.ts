...
export const insertAll = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    await ctx.db.insert("applications", {
      ...
      entrepreneurshipInterest: "I've been coding since I was 12 and have already built two apps — one for my church's event management and another to help classmates organize study groups. I want to learn how to turn my ideas into sustainable businesses that can create real change.",
      aiInterest: "I'm fascinated by how AI can help small churches and nonprofits be more effective with limited resources. I've been experimenting with ChatGPT to help write grant proposals for my church and I want to build a tool that makes this accessible to everyone.",
      parentName: "Margaret Watson",
    ...
    await ctx.db.insert("applications", {
      ...
      entrepreneurshipInterest: "I started a small lawn care business last summer and learned so much about customer service, pricing, and managing finances. Now I want to bring that same energy to building tech products that solve problems for teens like me.",
      aiInterest: "I've been using AI tools to help me learn programming faster, and I think there's a huge opportunity to build AI-powered tutoring tools specifically designed for Christian schools that align with their values.",
    ...
    await ctx.db.insert("applications", {
      ...
      entrepreneurshipInterest: "I've been running an Etsy shop selling hand-lettered Bible verse prints for two years. I've shipped over 500 orders and learned about e-commerce, supply chain, and digital marketing. I'm ready to think bigger.",
      aiInterest: "I want to explore how AI can help small creative businesses scale without losing their personal touch. Imagine AI that helps Christian artists reach more people while staying true to their mission.",
    ...
    await ctx.db.insert("applications", {
      ...
      entrepreneurshipInterest: "Built an environmental monitoring app that won a local science fair. Ready to scale it into a real product.",
      aiInterest: "Using AI for climate data analysis and environmental pattern recognition.",
    ...
    await ctx.db.insert("applications", {
      ...
      entrepreneurshipInterest: "Not much experience.",
      aiInterest: "Seems cool.",
